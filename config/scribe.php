...
return [
    ...
    'description' => 'Pure JSON REST API built with Laravel 13, Sanctum authentication, and spatie/laravel-query-builder.',
    ...
    'auth' => [
        ...
        'extra_info' => 'Call <code>POST /api/v1/auth/register</code> or <code>POST /api/v1/auth/login</code> to get a token, then pass it as <code>Authorization: Bearer {token}</code>.',
    ],
